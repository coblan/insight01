    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('par', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='childs', to='workload.Index', verbose_name='parent dir')),
            ],
        ),
        migrations.CreateModel(
            name='Work',
            fields=[
                ...
                ('par', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='workload.Index', verbose_name='\u76ee\u5f55')),
            ],
        ),
        migrations.CreateModel(
            name='WorkRecord',
            fields=[
                ...
                ('emp', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='employee.EmployeeModel', verbose_name='\u5458\u5de5')),
                ('work', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='workload.Work', verbose_name='\u5de5\u65f6\u7c7b\u578b')),
            ],
        ),
    ]
